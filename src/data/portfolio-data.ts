...
export const projects: Project[] = [
	...
	},
	{
		id: 4,
		title: 'Simada ',
		description: 'Салон красоты и SPA "Simada"',
		technologies: ['HTML', 'SCSS', 'JS', 'GitHub'],
		liveUrl: 'https://egeny-myasnikov.github.io/simada/',
		githubUrl: 'https://github.com/Egeny-Myasnikov/simada',
		images: [
			'/projects/simada/1.png',
			'/projects/simada/2.png',
			'/projects/simada/3.png',
			'/projects/simada/4.png',
			'/projects/simada/5.png',
			'/projects/simada/6.png',
		],
	},
	{
		id: 5,
		title: 'PUBG Hack',
		description: 'Лендинг по продаже читов для игры PUBG',
		technologies: ['HTML', 'SCSS', 'JS', 'JS', 'GULP', 'GitHub'],
		liveUrl: 'https://egeny-myasnikov.github.io/pubg/',
		githubUrl: 'https://github.com/Egeny-Myasnikov/pubg',
		images: [
			'/projects/pubgСheats/1.png',
			'/projects/pubgСheats/2.png',
			'/projects/pubgСheats/3.png',
			'/projects/pubgСheats/4.png',
			'/projects/pubgСheats/5.png',
			'/projects/pubgСheats/6.png',
		],
	},
	{
		id: 6,
